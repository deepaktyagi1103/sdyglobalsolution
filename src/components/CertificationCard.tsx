...
import { Award, Globe, Cpu, Trash, Recycle, Battery, Circle, Droplet, Leaf, Truck, CheckSquare, FileText, DivideIcon as LucideIcon, CheckCircle } from "lucide-react";
...
const CertificationCard: React.FC<CertificationCardProps> = ({ service, index }) => {
